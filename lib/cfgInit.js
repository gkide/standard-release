    ...
    commitRules: {
        ...
        header: {
            ...
            type: [
                ...
                { category: 'Major', skip: false, isFilter: true,  name: 'major' },
                { category: 'Major', skip: false, isFilter: true,  name: 'break' },
                { category: 'Major', skip: false, isFilter: true,  name: 'breaking' },
                // Introduces a new feature to the codebase
                // - Correlates with MINOR in semantic versioning
                { category: 'Features', skip: false, isFilter: true,  name: 'minor' },
                { category: 'Features', skip: false, isFilter: true,  name: 'feat' },
                { category: 'Features', skip: false, isFilter: true,  name: 'feature' },
                // Patches a bug in the codebase
                // - Correlates with PATCH in semantic versioning
                { category: 'BugFixes', skip: false, isFilter: true,  name: 'patch' },
                { category: 'BugFixes', skip: false, isFilter: true,  name: 'fix' },
                { category: 'BugFixes', skip: false, isFilter: true,  name: 'bugfix' },
                //////////////////////////////////////////////////
