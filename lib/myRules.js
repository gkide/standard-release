...
exports.commitRules = {
    ...
    header: {
        ...
        type: [
            ...
            //------------------------------------------------------------------
            // Something Work In Process(WIP) or perview
            ...
            //------------------------------------------------------------------
            // Skip commit style checking for some reason
...
// Group symbols for grouped commit message for changelog
exports.groupSymbols = [
    { skip: false, name: 'Features', symbol: '☕' },
    { skip: false, name: 'Security', symbol: '☠' },
    { skip: false, name: 'Fixed', symbol: '⛨' },
    { skip: false, name: 'Changed', symbol: '⚒' },
    { skip: false, name: 'Preview', symbol: '⚑' },
    { skip: false, name: 'Deprecated', symbol: '⚠' },
    { skip: false, name: 'Incompatible', symbol: '⛔' },
    { skip: false, name: 'Dependencies', symbol: '☂' },
]
