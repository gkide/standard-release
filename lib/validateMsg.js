...
function validateMsg(helper, commitMsg) {
    ...
    // header:scope
    checkObj = commitRules.getScopeValidateCallback(msgRules, helper);
    ...
    // header:subject
    checkObj = commitRules.getsubjectValidateCallback(msgRules, helper);
    ...
    // body
    checkObj = commitRules.getBodyValidateCallback(msgRules, helper);
    ...
    // footer
    checkObj = commitRules.getFooterValidateCallback(msgRules, helper);
