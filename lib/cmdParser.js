...
module.exports = require('yargs')
  ...
  .option('changelog-timestamp', {
    alias: 'a', // append
    describe: 'Changelog "Released" with timestamp prefix, default false',
    type: 'boolean'
  })
  .group([
    'init', 'message', 'changelog', 'changelog-from', 'changelog-template',
    'changelog-greed', 'changelog-release', 'changelog-timestamp'
    ], 'Core:'
  )
  .option('major', {
    alias: 'X',
